...
# Local Variables - YYC
v_airline_code = "YYC"
v_airline_name = "Calgary International Airport"
v_bound = "Departure"
quote_page = 'https://www.catsa-acsta.gc.ca/en/airport/calgary-international-airport'
...
with open(v_file_name, 'w', newline='') as f1:
    ...
    for tr in soup.find_all('tr')[1:]:
        tds = tr.find_all('td')
        row = v_airline_code + "," + v_airline_name + "," + tds[0].text.strip() [:2] + "," + v_bound + "," + tds[0].text.strip() [2:] + "," + tds[0].text.strip() + "," + tds[1].text.strip() + "\n"
        f1.write(row)
